export function getSalesReturnStatusBadgeClasses(status: string): string {
...
export const SALES_RETURN_STATUS_OPTIONS = ['draft', 'approved', 'completed', 'cancelled'] as const

export const REVENUE_STATUS_OPTIONS = ['draft', 'approved', 'posted'] as const

export function getRevenueStatusBadgeClasses(status: string): string {
...
export function formatRevenueStatusLabel(status: string, t: (key: string) => string): string {

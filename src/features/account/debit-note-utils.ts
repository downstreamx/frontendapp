export function getDebitNoteStatusBadgeClasses(status: string): string {
...
export const DEBIT_NOTE_STATUS_OPTIONS = ['draft', 'partial', 'approved', 'applied'] as const

export function formatDebitNoteStatusLabel(
  status: string,
  t: (key: string) => string,
): string {

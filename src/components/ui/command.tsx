...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3">
    ...
    <input
      ref={ref}
      className={`flex h-12 w-full rounded-md bg-transparent py-3 text-base outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
      {...props}
    />
  </div>
))
